			...
			<ItemInfoContainer name={ name } rating={ rating } description={
				<ul>
					...
					<li>Interned at CvilleIT as a Full-Stack Developer and was mentored to become their Lead Front-End Designer (2013)</li>
						...
						<li>Created a proprietary customizable ModX slider chunk for use on a website for <a href="tickets.phish.com">Phish</a> and others</li>
						<li>Dealt with social media integrations for Facebook, Twitter, Instagram, Youtube, Spotify and SoundCloud</li>
						<li>Added a video submission page to Kenny Chesney's website with format and size validation</li>
